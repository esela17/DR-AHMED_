...
const translations: Record<string, TranslationValue> = {
  ...
  'hero.subtitle': { ar: 'أ.د. أحمد عبدالله مهلهل — أستاذ بكلية الطب جامعة القاهرة (قصر العيني)، استشاري طب وجراحة العيون وجراحة الشبكية لدى مستشفى العيون الدولي، وعضو الجمعية الشبكية المصرية (EGVRS).', en: 'Prof. Dr. Ahmed Abdullah Mohelhel — Professor at Cairo University (Kasr Al-Ainy), Consultant of Ophthalmology and Vitreoretinal Surgery at International Eye Hospital, and member of EGVRS.' },
  ...
  'about.p2': { ar: 'إلى جانب عمله الأكاديمي بجامعة القاهرة (قصر العيني)، يشغل منصب استشاري طب وجراحة العيون وجراحة الشبكية لدى مستشفى العيون الدولي، وطبيب استشاري بمركز نور العيون التخصصي بالهرم، وهو عضو الجمعية الشبكية المصرية (EGVRS). يلتزم أ.د. أحمد مهلهل بمواكبة أحدث الأبحاث العلمية والتقنيات العلاجية العالمية لضمان سلامة المرضى وراحتهم.', en: 'Alongside his academic work at Cairo University (Kasr Al-Ainy), he serves as Consultant of Ophthalmology and Vitreoretinal Surgery at International Eye Hospital, Consultant at Nour El-Oyoun Center, and is a member of the Egyptian Vitreoretinal Society (EGVRS). Prof. Dr. Ahmed Mohelhel is committed to following the latest international scientific research and therapeutic techniques to ensure patient safety and comfort.' },
